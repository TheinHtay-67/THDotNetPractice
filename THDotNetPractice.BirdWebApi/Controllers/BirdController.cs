...
using THDotNetPractice.BirdWebApi.Models;

namespace THDotNetPractice.BirdWebApi.Controllers
{
    ...
    public class BirdController : ControllerBase
    {
        ...
        public async Task<IActionResult> Get()
        {
            ...
            if(response.IsSuccessStatusCode)
            {
                ...
                //    ImagePath = $"https://burma-project-ideas.vercel.app/{bird.ImagePath}",
                //}).ToList();
